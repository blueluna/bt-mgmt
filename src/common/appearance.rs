...
impl From<u16> for Appearance {
    fn from(value: u16) -> Appearance {
        ...
        match (category, sub_category) {
            (0, 0) => Appearance::Unknown,
            (1, 0) => Appearance::Phone,
            (2, 0) => Appearance::Computer,
            (3, 1) => Appearance::Watch(Watch::Sport),
            (3, 0) => Appearance::Watch(Watch::Generic),
            (4, 0) => Appearance::Clock,
            (5, 0) => Appearance::Display,
            (6, 0) => Appearance::RemoteControl,
            (7, 0) => Appearance::EyeGlasses,
            (8, 0) => Appearance::Tag,
            (9, 0) => Appearance::Keyring,
            (10, 0) => Appearance::MediaPlayer,
            (11, 0) => Appearance::BarcodeScanner,
            (12, 1) => Appearance::Thermometer(Thermometer::Ear),
            (12, 0) => Appearance::Thermometer(Thermometer::Generic),
            (13, 1) => Appearance::HeartRateSensor(HeartRateSensor::Belt),
            (13, 0) => Appearance::HeartRateSensor(HeartRateSensor::Generic),
            (14, 1) => Appearance::BloodPressure(BloodPressure::Arm),
            (14, 2) => Appearance::BloodPressure(BloodPressure::Wrist),
            (14, 0) => Appearance::BloodPressure(BloodPressure::Generic),
            ...
            (15, 0) => Appearance::HumanInterfaceDevice(HumanInterfaceDevice::Generic),
            (16, 0) => Appearance::GlucoseMeter,
            ...
            (17, 0) => Appearance::RunningWalkingSensor(RunningWalkingSensor::Generic),
            ...
            (18, 0) => Appearance::Cycling(Cycling::Generic),
            ...
            (19, 0) => Appearance::GenericControlDevice(GenericControlDevice::Generic),
            (20, 1) => Appearance::GenericNetworkDevice(GenericNetworkDevice::AccessPoint),
            (20, 0) => Appearance::GenericNetworkDevice(GenericNetworkDevice::Generic),
            ...
            (21, 0) => Appearance::Sensor(Sensor::Generic),
            ...
            (22, 0) => Appearance::Fan(Fan::Generic),
            ...
            (23, 0) => Appearance::Fan(Fan::Generic),
            (_, _) => Appearance::Reserved,
        }
    }
}
